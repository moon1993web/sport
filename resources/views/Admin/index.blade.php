                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                                    <img alt="بررسی وب‌سایت" class="card-website-analytics-img" src="{{ asset('Admin/assets/img/illustrations/card-website-analytics-1.png')}}" width="170"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                                <img alt="بررسی وب‌سایت" class="card-website-analytics-img" src="{{ asset('Admin/assets/img/illustrations/card-website-analytics-2.png')}}" width="170"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                                <img alt="بررسی وب‌سایت" class="card-website-analytics-img" src="{{ asset('Admin/assets/img/illustrations/card-website-analytics-3.png')}}" width="170"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <ul class="p-0 m-0">
                                        <li class="d-flex align-items-center mb-4">
                                            <img alt="User" class="rounded-circle me-3" src="{{ asset('Admin/assets/svg/flags/us.svg')}}" width="40"/>
                                        ...
                                        <li class="d-flex align-items-center mb-4">
                                            <img alt="User" class="rounded-circle me-3" src="{{ asset('Admin/assets/svg/flags/br.svg')}}" width="40"/>
                                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                                    <div class="d-flex align-items-center">
                                                        <h6 class="mb-0 me-1">
                                        ...
                                        <li class="d-flex align-items-center mb-4">
                                            <img alt="User" class="rounded-circle me-3" src="{{ asset('Admin/assets/svg/flags/in.svg')}}" width="40"/>
                                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                                    <div class="d-flex align-items-center">
                                                        <h6 class="mb-0 me-1">
                                        ...
                                        <li class="d-flex align-items-center mb-4">
                                            <img alt="User" class="rounded-circle me-3" src="{{ asset('Admin/assets/svg/flags/au.svg')}}" width="40"/>
                                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                                    <div class="d-flex align-items-center">
                                                        <h6 class="mb-0 me-1">
                                        ...
                                        <li class="d-flex align-items-center mb-4">
                                            <img alt="User" class="rounded-circle me-3" src="{{ asset('Admin/assets/svg/flags/fr.svg')}}" width="40"/>
                                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                                    <div class="d-flex align-items-center">
                                                        <h6 class="mb-0 me-1">
                                        ...
                                        <li class="d-flex align-items-center">
                                            <img alt="User" class="rounded-circle me-3" src="{{ asset('Admin/assets/svg/flags/cn.svg')}}" width="40"/>
                                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                <div class="me-2">
                                                    <div class="d-flex align-items-center">
                                                        <h6 class="mb-0 me-1">
