...
(function () {
    ...
    if (flatpickrDate) {
        flatpickrDate.flatpickr({
            calendar: "jalali", // اضافه شد: تقویم را شمسی می‌کند
            locale: "fa",
            altInput: true, // اضافه شد: برای نمایش فرمت زیبا
            altFormat: "Y/m/d",
            dateFormat: "Y/m/d", // اضافه شد: برای ارسال فرمت استاندارد به سرور
            disableMobile: "true",
            monthSelectorType: "static", // این خط از قبل بود
        });
    }
